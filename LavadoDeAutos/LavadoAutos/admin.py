...
from .models import Insumos, Instalaciones, Empleados, Slider, Mision, Vision, TipoContacto, Contacto
...
class ContactoAdmin(admin.ModelAdmin):
    list_display = ['cod','name', 'lastname', 'tipoContacto','asunto', 'mensaje']
